...
router.post('/sync-firebase-user', authRateLimiter, validateRequest({ body: syncFirebaseUserSchema }), authController.syncFirebaseUser);
...
router.patch('/change-password', authenticate, validateRequest({ body: changePasswordSchema }), authController.changePassword);
